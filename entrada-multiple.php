		...
		<main class="container-fluid">
			<div class="row main-stock">
				...
				<div class="col-12 col-sm-12 fieldset">
					...
					<div class="row">
						<div class="col-12 col-sm-2 form-inline" style="margin-top: 12px">
						...
						<div class="col-12 col-sm-7 form-inline" style="margin-top: 12px">
							&nbsp;
						</div>
				    	<div class="col-12 col-sm-1 form-inline" style="margin-top: 12px">
				    		<button class="btn btn-secondary btn-block my-1" style="font-size:10px;" onclick="printDiv() ">
				    	...
				    	<div class="col-12 col-sm-1 form-inline" style="margin-top: 12px">
				    		<button class="btn btn-danger btn-block my-1" style="font-size:10px;" onclick="location.href='entrada-multiple.php'">
			...
			<div class="row">
				<table class="col-12 col-sm-12 table" id="table">
					<thead>
						...
						<tr>
							<th width="8%" onclick="sortTable(0,'str')" class="sort">Codigo</th>
							<th width="25%" onclick="sortTable(1,'str')" class="sort">Marca</th>
