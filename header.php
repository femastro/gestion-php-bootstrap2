...
if (!empty($_SESSION['login'])) {
	...
	&nbsp;
								    ...
								    <li class="nav-item text-right" style="color:white;font-size:12px">
								    	...
								    	<p style="position: relative;top:14px">Sucursal :&nbsp;
								        	<span id="local"></span>
								        </p>
								    </li>
								    &nbsp;
										...
										<script>
											$(document).ready(function(){
												...
												function getRole(){
													...
													if (role < 3) {
														tipoCuenta = "Mi Cuenta";
														$('#a-tipo-cuenta').attr('href',"micuenta.php");
													}else{
														tipoCuenta = "Admin";
														$('#a-tipo-cuenta').attr('href',"admin.php");
													}
													return tipoCuenta;
												}
												$('#tipo-cuenta').html(role);
											});
										</script>
							        	<a class="nav-link mt-1" href="#" id="a-tipo-cuenta"> <!-- aca va on onclick para chequear el Role de Usuario -->
							        		...
							        		<span id="tipo-cuenta"></span>
							        	</a>
							      	</li>
								    <li class="nav-item">
							        	<a class="nav-link mt-1" href="php/logout.php">
